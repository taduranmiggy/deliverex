    ...
    return (
      <div className="customer-page pwa-page">
        <header className="pwa-page-header">
          <p className="pwa-page-eyebrow">History</p>
          <h1>Delivery History</h1>
          <p>Sign in to view shipments linked to your account.</p>
        </header>
        <div className="customer-content">
          <div className="pwa-empty-state pwa-empty-state--float">
            ...
            <div className="pwa-empty-state__actions">
              ...
              <Link to="/customer/login" className="btn-dx-secondary">Sign In</Link>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="customer-page pwa-page">
      <header className="pwa-page-header pwa-page-header--compact">
        <p className="pwa-page-eyebrow">History</p>
        <h1>My Deliveries</h1>
        <p>{orders.length} shipment{orders.length === 1 ? '' : 's'} linked to your account</p>
      </header>
