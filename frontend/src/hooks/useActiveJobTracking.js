...
const MOVING_INTERVAL_MS = Number(import.meta.env.VITE_GPS_INTERVAL_MOVING_SECONDS || 10) * 1000
const STOPPED_INTERVAL_MS = Number(import.meta.env.VITE_GPS_INTERVAL_STOPPED_SECONDS || 45) * 1000
