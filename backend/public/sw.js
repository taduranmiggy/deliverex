const CACHE = 'deliverex-customer-v7'
const SHELL = ['/', '/index.html', '/manifest.json', '/favicon.svg', '/customer', '/customer/login', '/customer/track', '/customer/about', '/customer/services']
