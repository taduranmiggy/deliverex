...
<p style="margin:0 0 14px;font-size:0.8125rem;color:#64748b;">This secure link expires in {{ config('auth.passwords.invitations.expire', 10080) }} minutes (about {{ number_format(config('auth.passwords.invitations.expire', 10080) / 60 / 24, 0) }} days).</p>
@endsection
